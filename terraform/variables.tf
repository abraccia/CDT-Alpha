...
variable "kali_image_name" { default = "kalilinux-amd64-cloud-20250910"}
...
variable "ubuntu_hostnames" { default = ["blog", "database", "icmp", "ssh", "smtp", "imap", "icmp2"] }
variable "windows_hostnames" { default = ["rdpthesequel", "dc", "icmp"]}
